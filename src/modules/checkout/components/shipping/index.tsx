        ...
        <>
          <div className="grid">
            <div className="flex flex-col">
              ...
              <span className="mb-4 text-white/70 text-base">
                ...
                {hasPickupOptions && (
                  ...
                  >
                    <Radio
                      ...
                      className={clx(
                        "flex items-center justify-between text-small-regular cursor-pointer py-4 border rounded-rounded px-8 mb-2 hover:border-light-green",
                        {
                          "border-dark-green":
                  ...
                  {_shippingMethods?.map((option) => {
                    ...
                    return (
                      <Radio
                        ...
                        disabled={isDisabled}
                        className={clx(
                          "flex items-center justify-between text-small-regular cursor-pointer py-4 border rounded-rounded px-8 mb-2 hover:border",
                          {
                            "border-dark-green": option.id === shippingMethodId,
                            "hover:border-light-green cursor-not-allowed":
                              isDisabled,
                          }
                        )}
                      >
                        ...
                        <span className="text-white justify-self-end text-ui-fg-base">
