...
const OrderSummary = ({ order }: OrderSummaryProps) => {
  ...
  return (
    <div className="text-white">
      <h2 className="text-xl font-semibold text-white mb-4 border-b border-gray-700 pb-2">Order Summary</h2>
        ...
        <div className="flex flex-col gap-y-3">
          {order.discount_total > 0 && (
            <div className="flex items-center justify-between">
              ...
              <span className="text-blue-400 font-medium">- {getAmount(order.discount_total)}</span>
            </div>
          )}
          {order.gift_card_total > 0 && (
            <div className="flex items-center justify-between">
              <span className="text-gray-300 font-medium">Gift Card</span>
              <span className="text-blue-400 font-medium">- {getAmount(order.gift_card_total)}</span>
            </div>
          )}
          <div className="flex items-center justify-between">
