      ...
      <div className="content-container flex flex-col justify-center items-center gap-y-10 max-w-4xl h-full w-full">
        ...
        >
          ...
          >
            ...
            <span className="text-gray-300">Your order was placed successfully.</span>
          </Heading>
          ...
          <Heading level="h2" className="text-white text-2xl font-bold mb-2 mt-4">
            Order Summary
          </Heading>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-white text-xl font-bold mb-4">Shipping Details</h3>
          ...
          <div className="mt-8 flex flex-col md:flex-row gap-4 justify-center">
            ...
            <LocalizedClientLink
              href="/"
              className="bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-lg font-medium text-center transition-colors"
            >
              Continue Shopping
            </LocalizedClientLink>
          </div>
