      ...
      <div className="relative h-[60vh] w-full overflow-hidden">
        {isPlaying ? (
          ...
          <div className="relative w-full h-full">
            ...
            <MuxVideoPlayer
              playbackId={
                season?.muxPlaybackId || t("media.videos.season1_playback_id")
              }
            ...
            <div className="relative w-full h-full">
              ...
              >
                <button
                  ...
                  className="bg-dark-green hover:bg-light-green text-white rounded-full p-4 transition-all duration-300 hover:scale-110"
                >
                  <svg
