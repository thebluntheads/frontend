...
const OrderCard = ({ order }: OrderCardProps) => {
  ...
  return (
    <div className="bg-black/30 backdrop-blur-md border border-white/10 rounded-xl p-6 flex flex-col" data-testid="order-card">
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-white/60 text-sm" data-testid="order-created-at">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center text-sm text-white/80">
                  ...
                  <span className="text-white/60" data-testid="item-quantity">{i.quantity}</span>
                </div>
              </div>
            )
          })}
