...
const AddAddress = ({
  ...
  return (
    <>
      <button
        className="bg-black/30 backdrop-blur-md border border-white/10 rounded-xl p-5 min-h-[220px] h-full w-full flex flex-col items-center justify-center gap-4 hover:bg-black/40 transition-colors duration-200"
        onClick={open}
