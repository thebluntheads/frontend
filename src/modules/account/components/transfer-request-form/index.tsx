  ...
  return (
    <div className="flex flex-col gap-y-6 w-full">
        ...
        >
          <div className="flex flex-col gap-y-3 w-full">
            <div className="relative w-full">
              <label htmlFor="order_id" className="text-sm text-white/80 mb-1 block">Order ID</label>
              <Input 
                id="order_id"
            ...
            <SubmitButton
              className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-200 py-2.5 px-6 w-fit whitespace-nowrap self-end mt-2 font-medium"
            >
              Request Transfer
            </SubmitButton>
          </div>
      ...
      {!state.success && state.error && (
        <Text className="text-rose-400 text-right">
          {state.error}
        </Text>
      )}
      {showSuccess && (
