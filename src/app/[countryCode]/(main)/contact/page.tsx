...
export default function ContactPage() {
  return (
    <div className="w-full max-w-6xl mx-auto py-16 px-4 md:px-8">
      <h1 className="text-4xl md:text-5xl font-bold text-center mb-12 text-white">Contact</h1>
      ...
      <div className="bg-gray-900/30 rounded-xl border border-gray-800 overflow-hidden p-8 md:p-12">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center bg-gray-800/70 rounded-lg p-4 transition-colors hover:bg-gray-800">
              ...
              <div>
                ...
                <Link href="tel:+18883271022" className="text-xl text-white font-medium hover:text-light-green transition-colors">
                  (888) 327-1022
                </Link>
              </div>
            </div>
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-medium mb-6 text-white text-center">NFT Collection</h2>
          <div className="flex justify-center">
            <Link 
              href="https://opensea.io/collection/bluntheads" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center gap-3 bg-gray-800 hover:bg-gray-700 px-6 py-4 rounded-xl transition-colors"
            >
              <svg
                width="36"
                height="36"
              ...
              <span className="text-white font-medium text-lg">View Our NFT Collection on OpenSea</span>
            </Link>
          </div>
        </div>
      </div>
