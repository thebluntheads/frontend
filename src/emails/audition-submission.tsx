...
export interface AuditionSubmissionEmailProps {
  name: string
  email: string
  instagram: string
  tiktok: string
...
export default function AuditionSubmissionEmail({
  name,
  email,
  instagram,
  tiktok,
      ...
      >
        ...
        >
          ...
          <Section style={{ textAlign: "center", marginBottom: "32px" }}>
            ...
            >
              A new candidate has submitted an audition application
            </Text>
          </Section>
